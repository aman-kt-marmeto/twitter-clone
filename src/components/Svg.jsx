...
export function HomeSvg() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="home-svg">
      <g>
...
export function NotificationSvg() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="notification-svg">
      <g>
...
export function CrossSvg() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="cross-svg">
      <g>
